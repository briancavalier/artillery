...
import { appendLedgerEvent, readLedger, summarizeLedger } from "./ledger.js";
...
export function createArtilleryServer(publicDir = join(process.cwd(), "dist/public")): ArtilleryServer {
...
async function routeRequest(
  ...
  if (method === "GET" && url.pathname === "/v1/health") {
    ...
    await writeJson(response, 200, summarizeLedger(events));
    return;
  }
